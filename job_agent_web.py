        ...
        <div class="section section-add-url" style="margin-top:8px;margin-bottom:8px;padding:8px 0;width:100%;box-sizing:border-box">
            ...
            <div id="manual-add-form" style="display:none;margin-top:10px;border:1px solid #e0e0e0;border-radius:8px;padding:14px;background:#fafafa;width:100%;box-sizing:border-box">
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;width:100%">
                    ...
                    <div><label style="font-size:13px;color:#555">{manual_add_company}</label><br><input id="mf-company" type="text" style="width:calc(100% - 2px);padding:7px 8px;border:1px solid #ddd;border-radius:6px;font-size:14px;box-sizing:border-box"></div>
                    <div><label style="font-size:13px;color:#555">{manual_add_location}</label><br><input id="mf-location" type="text" style="width:calc(100% - 2px);padding:7px 8px;border:1px solid #ddd;border-radius:6px;font-size:14px;box-sizing:border-box"></div>
                    <div><label style="font-size:13px;color:#555">{manual_add_url}</label><br><input id="mf-url" type="url" style="width:calc(100% - 2px);padding:7px 8px;border:1px solid #ddd;border-radius:6px;font-size:14px;box-sizing:border-box"></div>
                    <div><label style="font-size:13px;color:#555">{manual_add_job_type}</label><br><input id="mf-job-type" type="text" placeholder="e.g. Full-time, Contract..." style="width:calc(100% - 2px);padding:7px 8px;border:1px solid #ddd;border-radius:6px;font-size:14px;box-sizing:border-box"></div>
                    <div><label style="font-size:13px;color:#555">{manual_add_recruiter_name}</label><br><input id="mf-recruiter-name" type="text" style="width:calc(100% - 2px);padding:7px 8px;border:1px solid #ddd;border-radius:6px;font-size:14px;box-sizing:border-box"></div>
                    <div><label style="font-size:13px;color:#555">{manual_add_recruiter_phone}</label><br><input id="mf-recruiter-phone" type="tel" style="width:calc(100% - 2px);padding:7px 8px;border:1px solid #ddd;border-radius:6px;font-size:14px;box-sizing:border-box"></div>
                    <div><label style="font-size:13px;color:#555">{manual_add_recruiter_email}</label><br><input id="mf-recruiter-email" type="email" style="width:calc(100% - 2px);padding:7px 8px;border:1px solid #ddd;border-radius:6px;font-size:14px;box-sizing:border-box"></div>
                </div>
                <div style="margin-top:8px"><label style="font-size:13px;color:#555">{manual_add_desc}</label><br><textarea id="mf-desc" rows="16" style="width:calc(100% - 2px);padding:7px 8px;border:1px solid #ddd;border-radius:6px;font-size:14px;box-sizing:border-box;resize:vertical"></textarea></div>
